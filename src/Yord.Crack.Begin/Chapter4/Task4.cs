...
namespace Yord.Crack.Begin.Chapter4
{
    ...
    {
        // PERFECT
        // рекурсивно получаем высоту левого и правого узла для каждого поддерева, пока нет ошибки
        ...
        // при кадом откате назад берем высоту максимального поддерева текущего узла и +1, потому что идем на уровень выше
